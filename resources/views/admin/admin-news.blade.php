                ...
                <table class="table-auto w-full bg-floral-white rounded-xl shadow-md border border-amber-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-left">{{$news_item->content}} {{$news_item->content}} {{$news_item->content}} {{$news_item->content}} {{$news_item->content}} {{$news_item->content}} {{$news_item->content}} {{$news_item->description}} {{$news_item->content}} {{$news_item->content}}</td>
                            <td class="py-2 px-4 border-b text-left"><img src="{{$news_item->picture}}" alt=""></td>
