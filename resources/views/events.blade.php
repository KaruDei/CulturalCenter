...
<div class="flex flex-col container items-stretch ml-auto mr-auto mt-[-80px]">
                ...
                <div class="grid grid-cols-4 gap-5">
                    <a href="events/1" class=" bg-floral-white rounded-xl shadow-2xl max-w-4xl border border-amber-100  w-[400fr] h-[600px] flex flex-col items-center overflow-hidden">                     
